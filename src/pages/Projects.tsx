...
export default function ProjectsPage() {
  usePageMeta({
    title: "All Projects — Avinash Thakur",
    description: "Complete archive of Avinash Thakur's GitHub repositories — SaaS products, client work, and full-stack experiments. Live README previews on hover.",
    path: "/projects",
  });
